...
void jni_reflect_java_class(JavaClass ** p_jc, JNIEnv *env) {
    ...
    jclass media_codec_class = (*env)->FindClass(env, "com/bunizz/instapetts/utils/trinity/decoder/MediaCodecDecode");
    ...
    java_class->codec_seek = (*env)->GetMethodID(env, media_codec_class, "seek", "()V");
