package com.bunizz.instapetts.utils.trimVideo.widget;
...
import com.bunizz.instapetts.utils.trimVideo.interfaces.IVideoTrimmerView;
...
import static com.bunizz.instapetts.utils.trimVideo.trim.VideoTrimmerUtil.MAX_COUNT_RANGE;
import static com.bunizz.instapetts.utils.trimVideo.trim.VideoTrimmerUtil.MAX_SHOOT_DURATION;
import static com.bunizz.instapetts.utils.trimVideo.trim.VideoTrimmerUtil.RECYCLER_VIEW_PADDING;
import static com.bunizz.instapetts.utils.trimVideo.trim.VideoTrimmerUtil.THUMB_WIDTH;
import static com.bunizz.instapetts.utils.trimVideo.trim.VideoTrimmerUtil.VIDEO_FRAMES_WIDTH;
...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
  ...
  private RelativeLayout mRedProgressIcon;
  TextView text_duration_finish,text_duration_start;
  ...
  private void init(Context context) {
    ...
    LayoutInflater.from(context).inflate(R.layout.crop_video_view, this, true);
    ...
    text_duration_finish = findViewById(R.id.text_duration_finish);
    text_duration_start = findViewById(R.id.text_duration_start);
  ...
  private void initRangeSeekBarView() {
    ...
    text_duration_start.setText("0:00");
    text_duration_finish.setText("30:00");
  }
  ...
  public void initVideoByURI(final Uri videoURI) {
   ...
   // mVideoShootTipTv.setText(String.format("MOTA FUKA", VideoTrimmerUtil.VIDEO_MAX_TIME));
  }
  ...
  private void onSaveClicked() {
    if (mRightProgressPos - mLeftProgressPos < VideoTrimmerUtil.MIN_SHOOT_DURATION) {
      Toast.makeText(mContext, "EL VIDEO ES MUY CORTO", Toast.LENGTH_SHORT).show();
    } else {
      mVideoView.pause();
  ...
  private final RangeSeekBarView.OnRangeSeekBarChangeListener mOnRangeSeekBarChangeListener = new RangeSeekBarView.OnRangeSeekBarChangeListener() {
    ...
    public void onRangeSeekBarValuesChanged(RangeSeekBarView bar, long minValue, long maxValue, int action, boolean isMin,
      ...
      text_duration_start.setText((minValue / 1000 )+"");
      text_duration_finish.setText((maxValue)/1000+"");
  ...
  private void playingAnimation() {
    ...
    final RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mRedProgressIcon.getLayoutParams();
