   ...
   View root_view;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if( iconId!=NO_IMAGE )
            ...
            iconView.setImageResource(R.drawable.ic_hand_pet);
        iconView.setVisibility(View.INVISIBLE);
        iconView.setTag("iconView");
        this.addView(iconView);

        singleTapThread = new SingleTapThread(pressedTime, PRESS_TIME_GAP, isDoubleTapped, null);
    }
    ...
    public void animate_icon(View view){
        root_view = view;
        Log.e("ANIMATE_ICON","11");
        isDoubleTapped = false;
            ...
            if( !disableAnimation ) {
                Log.e("ANIMATE_ICON","33");
                animateIcon((ImageView) view.findViewWithTag("iconView"));
            }else{
                Log.e("ANIMATE_ICON","22");
            }
        pressedTime = System.currentTimeMillis();
        if(!singleTapThread.isAlive() ) {
            singleTapThread = new SingleTapThread(pressedTime, PRESS_TIME_GAP, true, null);
