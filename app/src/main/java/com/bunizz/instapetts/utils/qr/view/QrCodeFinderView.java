package com.bunizz.instapetts.utils.qr.view;
...
import com.bunizz.instapetts.utils.qr.utils.ScreenUtils;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    public QrCodeFinderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaskColor = resources.getColor(R.color.trans);
        mFrameColor = resources.getColor(R.color.trans);
        mLaserColor = resources.getColor(R.color.trans);
        mTextColor = resources.getColor(R.color.trans);
