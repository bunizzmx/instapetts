package com.bunizz.instapetts.utils.datepicker.date;
...
import com.bunizz.instapetts.utils.datepicker.WheelPicker;
...
public class YearPicker extends WheelPicker<Integer> {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mStartYear = a.getInteger(R.styleable.YearPicker_startYear, 1980);
        mEndYear = a.getInteger(R.styleable.YearPicker_endYear, 2020);
        a.recycle();
