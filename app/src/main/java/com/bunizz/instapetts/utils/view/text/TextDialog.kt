...
package com.bunizz.instapetts.utils.view.text
...
import com.bunizz.instapetts.utils.view.WheelView
import com.bunizz.instapetts.utils.view.entity.ColorViewHolder
import com.bunizz.instapetts.utils.view.entity.ColorViewPagerAdapter
...
//      }
  ...
  private fun initTableView(contentView: View) {
    ...
    mTabLayout?.setSelectedTabIndicatorColor(ContextCompat.getColor(contentView.context, R.color.primary))
