package com.bunizz.instapetts.utils.trimVideo.utils;
...
public class StorageUtil {
  ...
  public static String getCacheDir() {
    String filename = "INSTAPETS_" + UUID.randomUUID();
    if (TextUtils.isEmpty(sCacheDir)) {
      File file = null;
      Context context = BaseUtils.getContext();
      try {
          file =  new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath() + File.separator + "Instapetts"+ File.separator + filename + ".mp4");
        ...
        Log.w(TAG, "cache dir = " + ignored.getMessage());
      }
    }
    return sCacheDir;
  }
