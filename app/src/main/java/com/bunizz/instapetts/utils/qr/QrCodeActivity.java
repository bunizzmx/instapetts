package com.bunizz.instapetts.utils.qr;
...
/*
    ...
    private static Intent createIntent(Context context) {
        Intent i = new Intent(context, QrSearchActivity.class);
        return i;
    }
    ...
    private void initData() {
        ...
        mInactivityTimer = new InactivityTimer(QrSearchActivity.this);
