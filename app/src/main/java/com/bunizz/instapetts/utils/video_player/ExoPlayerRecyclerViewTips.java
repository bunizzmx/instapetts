...
public class ExoPlayerRecyclerViewTips extends RecyclerView {
   ...
   // private ProgressBar progressBar;
     ...
     */
    // Media List
    private ArrayList<Object> mediaObjects = new ArrayList<>();
    ...
    public ExoPlayerRecyclerViewTips(@NonNull Context context) {
        super(context);
        init(context);
    }
    public ExoPlayerRecyclerViewTips(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if(getChildViewHolder(child) instanceof TipsAdapter.TipsHolderVideo) {
            ...
            TipsBean data_parsed = (TipsBean) mediaObjects.get(targetPosition);
            String mediaUrl = data_parsed.getPhoto_tip();
            if (mediaUrl != null) {
    ...
    private void removeVideoView(PlayerView videoView) {
        Log.e("REMOVEMOS_VIDEO","SI");
        ViewGroup parent = (ViewGroup) videoView.getParent();
        if (parent == null) {
            return;
        }
        int index = parent.indexOfChild(videoView);
        if (index >= 0 && viewHolderParent!=null) {
