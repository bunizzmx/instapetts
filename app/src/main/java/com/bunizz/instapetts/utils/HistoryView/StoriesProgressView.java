...
public class StoriesProgressView extends LinearLayout {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.historia_pregress);
        storiesCount = typedArray.getInt(R.styleable.historia_pregress_progressCount, 0);
        typedArray.recycle();
        bindViews();
    }
