 ...
 *
 * @param context
 */(private val context: Context,private val assetDir: String,private val  targetDir: String) {


    public fun copy(context: Context,source: String, targetPath: String) {
     ...
     * @param dir  目标文件夹
     */
    public fun copyAssets( context: Context,assetDir: String, targetDir: String) {
