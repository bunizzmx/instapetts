...
public class PostGaleryPresenter implements  PostGaleryContract.Presenter{


    PostGaleryContract.View mView;
    Context mContext;
    ...
    PostGaleryPresenter(PostGaleryContract.View view, Context context) {
        this.mView = view;
    ...
    @Override
    public void getMorePost(int type_Search, int paginador,int id_usuario,int filter) {
